 ...
 * -i and -o cases
 * (tcp case)
 * /home/elioz/Operating_Systems/Ex2/exe6/mysocket
 * first terminal (UDSSS) :  ./mync -e "./ttt 123456789" -i UDSSS/home/elioz/Operating_Systems/Ex2/exe6/mysocket
 * second terminal: (UDSCS) :  ./mync -o UDSCS/home/elioz/Operating_Systems/Ex2/exe6/mysocket
 *
 * (udp case)
 *  first terminal (UDSSD): ./mync -e "./ttt 123456789" -i UDSSD/home/elioz/Operating_Systems/Ex2/exe6/mysocket
 *  second terminal(UDSCD) : ./mync -o UDSCD/home/elioz/Operating_Systems/Ex2/exe6/mysocket
 *
 *-b case (only for tcp)
 *
 *           first terminal:  ./mync -e "./ttt 123456789" -b UDSSS/home/elioz/Operating_Systems/Ex2/exe6/mysocket
 *           second terminal: ./mync -e "./ttt 123456789" -b UDSCS/home/elioz/Operating_Systems/Ex2/exe6/mysocket
 *
 *
 *
 *
